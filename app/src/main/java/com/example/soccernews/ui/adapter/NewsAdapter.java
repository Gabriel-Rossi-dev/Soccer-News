...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //Implementar a função de favoritar
        ...
        int favoriteColors;
        favoriteColors = news.favorite ? R.color.active : R.color.inactive;
        holder.binding.ivFavorite.setColorFilter(context.getResources().getColor(favoriteColors))   ;
    }
